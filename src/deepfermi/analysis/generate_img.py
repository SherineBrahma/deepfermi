...
def main(pdf_name_list,
    ...
    for i, path in enumerate(read_path):
        ...
        for j in tqdm(range(0, N)):
            ...
            range_lbfgs = [(param_lim[0][0],param_lim[0][1]), (param_lim[1][0],param_lim[1][1]), (param_lim[2][0],param_lim[2][1]), (0,None)]
            ...
            range_net = [(param_lim[0][0],param_lim[0][1]), (param_lim[1][0],param_lim[1][1]), (param_lim[2][0],param_lim[2][1]), (0,None)]
